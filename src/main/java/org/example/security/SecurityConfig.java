...
/**
 * Wires up authentication for the /api/auth/login slice and bearer-token
 * authentication for all other protected endpoints via {@link JwtAuthenticationFilter}.
 */
@Configuration
